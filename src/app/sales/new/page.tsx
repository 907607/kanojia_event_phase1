...
export default function CreateOrderPage() {
  ...
  // Helper state for the UI toggle
  ...
  // Handle Payment Mode Switching logic
  useEffect(() => {
    if (paymentMode === "CASH") {
      setFormData((prev) => ({ ...prev, paymentRef: "CASH" }));
    } else {
      // Clear 'CASH' when switching to UPI so user can type
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    min="1"
                    required
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white outline-none transition-all font-mono text-center text-lg"
                  ...
                  />
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 text-xs font-bold uppercase">
                    Qty
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  ...
                  >
                    ...
                    <span className="font-semibold text-sm">UPI / Online</span>
                  </button>
                </div>

                {/* Dynamic Input for UPI */}
                {paymentMode === "UPI" && (
